...
public class FSGRAPPLEPartitioningMain {
    ...
    private static void run(Dataset dataset) {
        try {
            System.setOut(new PrintStream(new FileOutputStream("h:\\Similarity_search\\Auxiliary_for_filtering\\GRAPPLE_partitioning\\" + dataset.getDatasetName() + "_err.csv", false)));
